	...
	<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
		<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
			<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
				<h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bold fs-3 m-0">Add Customer</h1>
...
@section('content')
                ...
                <div class='row'> <div class='col-md-12'> <div class='alert alert-success'> {{session()->get('success')}} </div> </div> </div>
                @endif
	...
	<form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row" method="POST" action="{{url('admin/addcustomer')}}" enctype="multipart/form-data">
		@csrf
			...
			<div class="card card-flush py-4">
				...
				<div class="card-body pt-0">
					<select class="form-select mb-2" name="status" data-control="select2" data-hide-search="true" data-placeholder="Select an option" id="kt_ecommerce_add_category_status_select">
						...
						<option value="Archive">Delete/Archive</option>
					</select>
				</div>
			</div>
		</div>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="mb-5 fv-row">
								...
								<input type="text" name="customer_name" class="form-control mb-2"  placeholder="" value="" />
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="mb-5 fv-row">
								...
								<input type="text" name="Guaranteed_person" class="form-control mb-2" required value="" />
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="mb-5 fv-row">
								...
								<input type="text" name="phone_number" class="form-control mb-2" required value="" />
							</div>
						</div>
						<div class="col-md-12">
							<div class="mb-5 fv-row">
								<label class="required form-label">Complete Address</label>
								<input type="text" name="complete_address" class="form-control mb-2" required  value="" />
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="mb-10">
								...
								<div class="text-muted fs-7">This is the amount you gave that person while onboarding.</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="mb-10">
								...
								<div class="text-muted fs-7">The amount of discount applied to the supply of chicken he gets</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="mb-10">
