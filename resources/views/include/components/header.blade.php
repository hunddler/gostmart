    ...
    <div class="d-flex flex-stack flex-grow-1">
        <div class="app-header-logo d-flex align-items-center ps-lg-12" id="kt_app_header_logo">
            ...
            <a href="index.html" class="app-sidebar-logo">
                <img alt="Logo" src="{{asset('assets/media/logos/gosthmart.png')}}" class="h-85px theme-light-show" />
                <img alt="Logo" src="{{asset('assets/media/logos/gosthmart.png')}}" class="h-25px theme-dark-show" />
            </a>
            <!--end::Logo-->
        </div>
        <!--begin::Navbar-->
        <div class="app-navbar flex-grow-1 justify-content-end" id="kt_app_header_navbar">
            ...
            <div class="app-navbar-item ms-2 ms-lg-6 me-lg-6">
                ...
                document.getElementById('logout-form').submit();" class="btn btn-icon btn-custom btn-color-gray-600 btn-active-color-primary w-35px h-35px w-md-40px h-md-40px"><i class="ki-outline ki-exit-right fs-1"></i></a>
